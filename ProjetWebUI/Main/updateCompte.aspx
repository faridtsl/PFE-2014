...
<form id="form1" runat="server">
		<div class="CentreDiv" id="RubRep">
			...
			<div id="ctl00_MainContent_MenuChambreRep" class="contenuRubRep">
                <span class="bulleRouge">•</span><a class="contenuRubRep" href="updatepwd.aspx"> 
				تغيير كلمة المرور</a> <br />
				<br />
				<br />
                <span class="bulleRouge">•</span><a class="contenuRubRep" href="updatepre.aspx"> 
				تحديث معلومات الرئيس </a><br />
				<br />
				<br />
                <span class="bulleRouge">•</span><a class="contenuRubRep" href="updateass.aspx"> 
